"""
Nexari SageMaker training script.
Generic text classification fine-tuning for any HuggingFace backbone.
Compatible with PyTorch 2.1 + transformers 4.35.x
"""
import os
import json
import argparse
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        no_cuda=True,                        # explicit CPU mode
        report_to="none",
        logging_steps=50,
    )
